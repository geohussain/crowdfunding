...
def add_payments(project, partners, expenses):
    ...
    project.add_payment(8000, datetime(2025, 9, 17), partners['ali_aldawood'], expenses['land_one_second_land_fill'])
    ...
    project.add_payment(20000, datetime(2025, 9, 3), partners['ali_aldawood'], expenses['plumbing_supplies_wallet'])
